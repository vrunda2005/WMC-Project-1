    ...
    <>
      ...
      {isModalOpen && selectedNews && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-3xl mx-4 sm:mx-auto relative">
            <button
              onClick={closeModal}
            ...
            <img className="w-full h-auto mb-6 rounded-lg" src={selectedNews.image} alt={selectedNews.title} />
