...
function MembershipPage() {
  ...
  useEffect(() => {
    ...
    return (
      <div className={`mx-auto px-4 py-8 md:px-8 md:py-7 lg:px-12 lg:py-16 page-background ${overlay} ` }>
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap justify-center gap-8 md:gap-10 lg:gap-12 mb-12">
          ...
          {/* Elite Membership */}
          <div className={`${containerBgColor}  bg-opacity-80 p-6 md:p-8 lg:p-10 shadow-lg rounded-lg hover:shadow-2xl hover:scale-105 transition-transform duration-300 ease-in-out w-full md:w-1/3 lg:w-1/4`}>
